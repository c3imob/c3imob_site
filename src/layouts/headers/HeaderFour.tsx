                     ...
                     <div className="right-widget ms-auto me-3 me-lg-0 order-lg-3">
                        <ul className="d-flex align-items-center style-none">
                           <li className="d-none d-md-inline-block me-4">
                              <Link href="/HOMY_TEMPLATES/dashboard/add-property" className="btn-ten rounded-0" target="_blank"><span>Add Listing</span> <i className="bi bi-arrow-up-right"></i></Link>
                           </li>
                           <li>
