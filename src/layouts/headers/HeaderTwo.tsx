...
import logo_2 from "@/assets/images/logo/logo_n_4.png";
import logo_1 from "@/assets/images/logo/logo_n_4.png";
import logo_3 from "@/assets/images/logo/logo_n_4.png";
                  ...
                  <div className="d-flex align-items-center">
                     <div className="logo order-lg-0">
                        <Link href="/" className="d-flex align-items-center">
                           <Image style={{height: "42px", width: "auto"}} src={style_2 ? logo_3 : style_1 ? logo_2 : logo_1} alt="" />
                        </Link>
                     </div>
