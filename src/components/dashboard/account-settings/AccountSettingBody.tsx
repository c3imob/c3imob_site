              ...
              <div className="dash-input-wrapper mb-20">
                ...
                <div className="info-text d-sm-flex align-items-center justify-content-between mt-5">
                  <p className="m0">
                    ...
                    <Link href="/HOMY_TEMPLATES/dashboard/account-settings/password-change">Click here</Link>
                  </p>
                  <Link href="/HOMY_TEMPLATES/dashboard/account-settings/password-change" className="chng-pass">
                    Change Password
                  </Link>
                </div>
              </div>
