      ...
      <div className="row gx-0 align-items-center">
        ...
        <div className="col-lg-4">
          <div className="d-flex align-items-center justify-content-between">
            ...
            <Link className="new-message-compose rounded-circle" data-bs-toggle="offcanvas" href="#offcanvasScrolling" role="button" aria-controls="offcanvasScrolling">
              +
            </Link>
          </div>
        </div>
        <div className="col-lg-8">
          <div className="message-pagination ps-lg-4 ps-xxl-5 d-flex align-items-center justify-content-between md-mt-40">
            ...
            <Link href="#" className="next-msg">
              <Image src={icon_2} data-src="images/icon/icon_27.svg" alt="" className="lazy-img" />
            </Link>
          </div>
        </div>
      </div>
