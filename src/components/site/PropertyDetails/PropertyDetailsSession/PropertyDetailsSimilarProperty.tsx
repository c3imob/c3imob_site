...
interface PropertyDetailsSimilarPropertyInterface {
  property: PropertyDetailsAreaDtoInterface;
}

const PropertyDetailsSimilarProperty = ({ property }: PropertyDetailsSimilarPropertyInterface) => {
  return (
              ...
              <div className="listing-card-one shadow4 style-three border-30 mb-50">
                <div className="img-gallery p-15">
                  <div className="position-relative border-20 overflow-hidden">
                    ...
                    <Link href="/property/Titulo2" className="btn-four inverse rounded-circle position-absolute">
...
export default PropertyDetailsSimilarProperty;
