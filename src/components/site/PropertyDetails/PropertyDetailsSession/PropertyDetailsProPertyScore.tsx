...
interface PropertyDetailsProPertyScoreInterface {
  property: PropertyDetailsAreaDtoInterface;
}

const PropertyDetailsProPertyScore = ({ property }: PropertyDetailsProPertyScoreInterface) => {
  return (
...
export default PropertyDetailsProPertyScore;
