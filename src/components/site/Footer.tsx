...
const { title, desc_1, desc_2, email, number } = footer_content;
         ...
         <div className="container container-large">
            <div className="bg-wrapper position-relative z-1">
               <div className="row justify-content-between">
                  ...
                  <div className="col-xl-9">
                     <div className="ms-xxl-5 ps-xl-5 lg-mt-20">
                        <div className="row justify-content-between">
            ...
            <div className="bottom-footer">
               <div className="d-md-flex justify-content-center justify-content-md-between align-items-center">
                  ...
                  <p className="mb-15 text-center text-lg-start order-md-first">Copyright @2024 C3 Imob inc.</p>
               </div>
            </div>
         </div>
      </div>
